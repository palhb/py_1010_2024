...
print(f"\nWelcome to Car Selector\nLet me help you deciede on what type of car to buy:\n")
...
total_cost_electric_car = int (insurance_electric + car_insurance_tax + km_usage_cost_electric)
total_cost_gas_car = int (insurance_gas + car_insurance_tax + km_usage_cost_gas)
